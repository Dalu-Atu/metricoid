    ...
    <Container>
      <Navigation>
        <div className="nav-container">
          <div className="logo">
            Metricoid<span className="accent">.</span>
          </div>
        ...
        <div className="hero-container">
          <div className="hero-grid">
            <HeroContent>
              ...
              <h1>
                Enterprise-Grade <span className="highlight">Digital</span>{" "}
                Solutions
              </h1>

              <p className="description">
                We deliver sophisticated, scalable digital experiences that
                drive measurable business growth. From strategy to execution,
